...
// Mapped to the same 3 limited positions: -2=Fan, 0=Neutral, 2=Business
const SPORTS_VOICE = {
...
{"take":{"position":${position},"label":"${effectiveLabel}","text":"your 40-60 word take here","sources":[{"name":"Source Name","framing":"one brief framing note"}]}}`;
    ...
    // Flag when no articles from the primary tier, OR when Claude signals it couldn't find relevant info
