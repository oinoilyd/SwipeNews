...
const T = {
  en: {
    ...
    loadingTagline: 'Form your own opinion.',
  ...
  es: {
    ...
    loadingTagline: 'Forma tu propia opinión.',
  ...
  fr: {
    ...
    loadingTagline: 'Formez votre propre opinion.',
  ...
  pt: {
    ...
    loadingTagline: 'Forme sua própria opinião.',
  ...
  de: {
    ...
    loadingTagline: 'Bilde dir deine eigene Meinung.',
  ...
  ar: {
    ...
    loadingTagline: 'كوّن رأيك بنفسك.',
